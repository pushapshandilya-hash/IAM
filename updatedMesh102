...
| Policy enforcement | Admission-control mechanism integrated with pipeline policy validation |
...
*Informative. This annex provides non-normative guidance for applying the multitenancy (SM-MT) controls. It does not add requirements.*
...
| 2.1 | YYYY-MM-DD | Added Multitenancy (SM-MT) domain and Appendix C guidance |
